    ...
    return (
        ...
        >
            ...
            <ul className={`absolute right-0 mr-4 px-[30px] flex justify-center items-center gap-[30px] ${poppins.className}`}>
                ...
                <Link href={'/#about-us'} className="text-lg font-medium hover:font-semibold">About Us</Link>

                <Link href={'/#services'} className="text-lg font-medium hover:font-semibold">Services</Link>

                <Link href={'/#projects'} className="text-lg font-medium hover:font-semibold">Projects</Link>
            </ul>
        </div>
    )
}
