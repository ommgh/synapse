...
const ProjectBox = ({project, setShowBox}: any) => {
    ...
    return (
        ...
        >
            <div
            className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-white z-[4] p-[70px] pb-[10px]"
            >
                <div
                ...
                >
                    ...
                    <ul
                    className="w-full text-xl font-medium flex gap-[30px] tracking-wide"
                    >
